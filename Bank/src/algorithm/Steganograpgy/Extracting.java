...
//    public static String extractSecretMessage(Bitmap stegoImage) {
    public static String extractSecretMessage(BufferedImage stegoImage) {
...
//        int keyPixel = stegoImage.getPixel(0, 0);
        int keyPixel = stegoImage.getRGB(0, 0);

//        int red = Color.red(keyPixel);
//        int green = Color.green(keyPixel);
//        int blue = Color.blue(keyPixel);

        int red = (keyPixel >> 16) & 0xff;
        int green = (keyPixel >> 8) & 0xff;
        int blue = (keyPixel) & 0xff;

//        com.example.sherif.Steganograpgy.StandardMethods.showLog("EXT", "Key2: " + red + " " + green + " " + blue);
        System.out.printf("EXT", "Key2: " + red + " " + green + " " + blue);
...
//        int tBlue = Color.blue(typePixel);
        ...
        int typePixel = stegoImage.getRGB(0, 1);
        int tRed = (typePixel >> 16) & 0xff;
        int tGreen = (typePixel >> 8) & 0xff;
        int tBlue = (typePixel) & 0xff;
...
//                int colors[] = {Color.red(pixel), Color.green(pixel), Color.blue(pixel)};
                ...
                int colors[] = {(pixel >> 16) & 0xff, (pixel >> 8) & 0xff, (pixel) & 0xff};
...
//        Log.d(TAG, "string builder to string" );
        System.out.printf("string builder to string");


        String sm = sb.toString();

//        Log.d(TAG, "Get string length" );
        System.out.printf("Get string length");


        int sL = sm.length();

//        Log.d(TAG, "Cut unnecessary [0-7] pixels" );
        System.out.printf("Cut unnecessary [0-7] pixels");
